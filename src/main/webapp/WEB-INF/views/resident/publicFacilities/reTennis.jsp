...
/**
 * 버튼의 상태를 현재 시간과 비교하여 사용시작 시간보다 현재 시간이 더 흘렀으면 버튼을 '사용완료'로 바꾸는 함수
 */
 function updateButtonStates() {
     ...
     $("#trShow tr").each(function() {
         ...
         console.log("updateButtonStates : " , beginTm);
...
$(document).ready(function () {
    ...
    /** 
    * 선택한 좌석이 변경될 때마다 이미 있는 예약을 체크해서 시간 테이블을 막아주는 함수
    */
    function updateTimetable() {
        let facCode = $("#inputFC").val();
        console.log("Selected Seat:", selectedSeat);

        // 먼저 좌석 선택을 하지 않으면 시간 선택 불가
        if (selectedSeat === "") {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (result > 0) {
                      ...
                      $("#can" + reserveSeq).html("취소 완료").removeClass("btn btn-primary").addClass("btn btn-light waves-effect");
	...
	<div class="row">
		<div class="col-12">
			<div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
				<p class="mb-sm-0" style="font-size:18px; color: #495057;"><img alt="" src="/resources/images/공.png" style="width: 20px;">&nbsp;<strong>테니스</strong></p>
				<div class="page-title-right">
					<ol class="breadcrumb m-0">
						<li class="breadcrumb-item"><a href="javascript: void(0);">공동시설물</a></li>
						<li class="breadcrumb-item active">테니스</li>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content" style="width: 749px;height: 740px;">
				...
				<div class="modal-body">
					...
					<div  style="float: left; width: 84%; margin:0px -10px -4px 13px; font-size: 16px;">
						<p>
							위&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;치&nbsp;&nbsp;&nbsp;<select name="seat" id="seat" required="required">
				...
				<div class="modal-footer">
					<button type="submit" id="reBtn" class="btn btn-primary">예약</button>
